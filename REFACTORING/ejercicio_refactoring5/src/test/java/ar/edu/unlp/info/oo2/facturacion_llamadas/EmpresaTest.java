...
class EmpresaTest {
	...
	void obtenerNumeroLibre() {
		...
		this.sistema.getGestorNumeros().cambiarTipoGenerador(new ConcreteStrategyPrimero());
		assertEquals("2214444554", this.sistema.obtenerNumeroLibre());

		this.sistema.getGestorNumeros().cambiarTipoGenerador(new ConcreteStrategyRandom());
